...
* ```bundle exec jekyll serve``` - checks for dependencies and builds it
* ```gem install <name>``` - install missing gems
...
The used theme is available as open source under the terms of the [MIT License](https://opensource.org/licenses/MIT).
